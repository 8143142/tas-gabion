(function () {
  ...
  const STATIC_KNOWLEDGE = [
    ...
    },
    {
      ...
      answer:
        'Используем оцинкованную габионную сетку по ГОСТ: диаметр проволоки 4 мм, ячейка 50 × 100 мм. Поставляем в рулонах 2 × 52 м — для заборов, стен, столбов и других конструкций.',
    ...
    },
    {
      ...
      answer:
        'Instagram: @tasgabion · Телефон: +7 (705) 685-46-89 · WhatsApp: wa.me/77056854689. Замер, расчёт и консультация — бесплатно.',
