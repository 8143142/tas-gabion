(function () {
  ...
  const STATIC_KNOWLEDGE = [
    ...
    },
    {
      ...
      answer:
        'Используем оцинкованную габионную сетку по ГОСТ: проволока 5 мм и 4 мм, ячейки 50/50 мм и 5/10, рулоны 2/3 м и 2/52 м — для заборов, стен, столбов и других конструкций.',
